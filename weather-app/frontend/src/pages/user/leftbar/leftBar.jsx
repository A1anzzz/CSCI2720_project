        ...
        <Navbar bg="light" expand="lg">
            <Container fluid>
                ...
                <Navbar.Collapse id="navbarScroll">
                    ...
                    navbarScroll>
                    <div className='mx-4'><button type="button" className="btn btn-primary" onClick={switchToThemeA}>Theme Blue</button></div>
                    <div className='mx-4'><button type="button" className="btn btn-primary" onClick={switchToThemeB}>Theme Red</button></div>
                    </Nav>
